class zcl_wcb_tr_invoice_itemwerks definition
  public
  final
  create public .
...
class zcl_wcb_tr_invoice_itemwerks implementation.
...
* local data
    ...
    create data rr_source_value type werks_d.
