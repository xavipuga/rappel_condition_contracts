class zcl_wcb_tr_invoice_salesorder definition
  public
  final
  create public .
...
class zcl_wcb_tr_invoice_salesorder implementation.
...
* local data
    ...
    create data rr_source_value type kdauf.
