    class zcl_wlf_italy_check_dates_upd definition
  public
  final
  create public .
      ...
      public section.
        ...
        interfaces if_wlf_cm_check_before_update .
      protected section.
      private section.
    endclass.
    ...
    class zcl_wlf_italy_check_dates_upd implementation.


      method if_wlf_cm_check_before_update~check.

        check c_komlfk-lfart = '0S14' and
              c_komlfk-vkorg = '1401'.

        try.
            zcl_italy_check_dates=>check_italy_dates(
              i_invoice_date = c_komlfk-wfdat
              i_bukrs        = c_komlfk-vkorg
            ).
